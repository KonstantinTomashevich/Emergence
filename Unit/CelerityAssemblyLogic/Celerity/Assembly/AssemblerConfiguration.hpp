...
CelerityAssemblyLogicApi Memory::Profiler::AllocationGroup GetAssemblerConfigurationAllocationGroup () noexcept;
...
struct CelerityAssemblyLogicApi CustomKeyDescriptor final
{
...
struct CelerityAssemblyLogicApi KeyBinding final
{
...
struct CelerityAssemblyLogicApi TypeDescriptor final
{
