...
{
#define EventsApi CelerityAssetModelApi
...
struct CelerityAssetModelApi AssetUserRemovedEventView
{
    Memory::UniqueString assetReferences[0u];
};

/// \brief Any autogenerated asset state update request event can be casted to this type.
struct CelerityAssetModelApi AssetStateUpdateEventView
{
...
CelerityAssetModelApi AssetReferenceBindingEventMap
