...
{
    Container::Vector<Contact3dFoundEvent> contactFound;
    Container::Vector<Contact3dPersistsEvent> contactPersists;
    Container::Vector<Contact3dLostEvent> contactLost;

    Container::Vector<Trigger3dEnteredEvent> triggerEntered;
    Container::Vector<Trigger3dExitedEvent> triggerExited;
};
} // namespace ValidatorTasks
