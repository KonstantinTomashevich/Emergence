...
static Storage RequestPlayerStorage (const Container::Vector<const void *> &_objects, std::uint8_t _sources)
{
    ...
    return {
        {
            RequestPlayerStorage (
                {&XAVIER_2_ARCHER_ALIVE_POISONED, &HUGO_0_KNIGHT_ALIVE_STUNNED, &KARL_1_MAGE_ALIVE_IMMOBILIZED},
                FLAG_PLAYER_ID_SOURCE),
        },
        {
            QueryAscendingRangeToRead {{{"playerId", "all"}, nullptr, nullptr}},
            CursorCheckAllOrdered {
                "all", {&HUGO_0_KNIGHT_ALIVE_STUNNED, &KARL_1_MAGE_ALIVE_IMMOBILIZED, &XAVIER_2_ARCHER_ALIVE_POISONED}},

            QueryDescendingRangeToRead {{{"playerId", "allDescending"}, nullptr, nullptr}},
            CursorCheckAllOrdered {
                "allDescending",
                {&XAVIER_2_ARCHER_ALIVE_POISONED, &KARL_1_MAGE_ALIVE_IMMOBILIZED, &HUGO_0_KNIGHT_ALIVE_STUNNED}},

            QueryAscendingRangeToRead {{{"playerId", "ids[1,2]"}, &Queries::ID_1, &Queries::ID_2}},
            CursorCheckAllOrdered {"ids[1,2]", {&KARL_1_MAGE_ALIVE_IMMOBILIZED, &XAVIER_2_ARCHER_ALIVE_POISONED}},

            QueryAscendingRangeToRead {{{"playerId", "ids[0]"}, &Queries::ID_0, &Queries::ID_0}},
            CursorCheckAllOrdered {"ids[0]", {&HUGO_0_KNIGHT_ALIVE_STUNNED}},

            QueryDescendingRangeToRead {{{"playerId", "ids[1,2,3]Descending"}, &Queries::ID_0, &Queries::ID_2}},
            CursorCheckAllOrdered {
                "ids[1,2,3]Descending",
                {&XAVIER_2_ARCHER_ALIVE_POISONED, &KARL_1_MAGE_ALIVE_IMMOBILIZED, &HUGO_0_KNIGHT_ALIVE_STUNNED}},

            QueryAscendingRangeToRead {{{"playerId", "ids[2,3]"}, &Queries::ID_2, &Queries::ID_3}},
            CursorCheckAllOrdered {"ids[2,3]", {&XAVIER_2_ARCHER_ALIVE_POISONED}},
...
Scenario OnStringField ()
{
    return {
        ...
        },
        {
            ...
            CursorCheckAllOrdered {"ioran-zanek", {&KARL_1_MAGE_ALIVE_IMMOBILIZED, &XAVIER_2_ARCHER_ALIVE_POISONED}},

            QueryAscendingRangeToRead {{{"playerName", "hugo-karl"}, &Queries::HUGO, &Queries::KARL}},
            CursorCheckAllOrdered {"hugo-karl", {&HUGO_0_KNIGHT_ALIVE_STUNNED, &KARL_1_MAGE_ALIVE_IMMOBILIZED}},

            QueryAscendingRangeToRead {{{"playerName", "xavier"}, &Queries::XAVIER, &Queries::XAVIER}},
            CursorCheckAllOrdered {"xavier", {&XAVIER_2_ARCHER_ALIVE_POISONED}},

            QueryDescendingRangeToRead {{{"playerName", "zanek-karl"}, &Queries::KARL, &Queries::ZANEK}},
            CursorCheckAllOrdered {"zanek-karl", {&XAVIER_2_ARCHER_ALIVE_POISONED, &KARL_1_MAGE_ALIVE_IMMOBILIZED}},
    ...
    return {
        {
            RequestPlayerStorage (
                {&XAVIER_2_ARCHER_ALIVE_POISONED, &HUGO_0_KNIGHT_ALIVE_STUNNED, &KARL_1_MAGE_ALIVE_IMMOBILIZED,
                 &KARL_1_MAGE_ALIVE_IMMOBILIZED, &KARL_1_MAGE_ALIVE_IMMOBILIZED},
                FLAG_PLAYER_ID_SOURCE),
        },
        {
            QueryAscendingRangeToRead {{{"playerId", "all"}, nullptr, nullptr}},
            CursorCheckAllOrdered {
                "all",
                {&HUGO_0_KNIGHT_ALIVE_STUNNED, &KARL_1_MAGE_ALIVE_IMMOBILIZED, &KARL_1_MAGE_ALIVE_IMMOBILIZED,
                 &KARL_1_MAGE_ALIVE_IMMOBILIZED, &XAVIER_2_ARCHER_ALIVE_POISONED}},

            QueryAscendingRangeToRead {{{"playerId", "1"}, &Queries::ID_1, &Queries::ID_1}},
            CursorCheckAllOrdered {
                "1", {&KARL_1_MAGE_ALIVE_IMMOBILIZED, &KARL_1_MAGE_ALIVE_IMMOBILIZED, &KARL_1_MAGE_ALIVE_IMMOBILIZED}},

            QueryDescendingRangeToRead {{{"playerId", "null-1(Descending)"}, nullptr, &Queries::ID_1}},
            CursorCheckAllOrdered {"null-1(Descending)",
                                   {&KARL_1_MAGE_ALIVE_IMMOBILIZED, &KARL_1_MAGE_ALIVE_IMMOBILIZED,
                                    &KARL_1_MAGE_ALIVE_IMMOBILIZED, &HUGO_0_KNIGHT_ALIVE_STUNNED}},
        }};
}
...
Scenario Edition ()
{
    return {{
            ...
            },
            {
                ...
                CursorCheck {"1-1", &KARL_1_MAGE_ALIVE_IMMOBILIZED},
                CursorEdit {"1-1", &XAVIER_2_ARCHER_ALIVE_POISONED},
                CursorIncrement {"1-1"},
                CursorCheck {"1-1", &KARL_1_MAGE_ALIVE_IMMOBILIZED},
                CursorEdit {"1-1", &HUGO_0_KNIGHT_ALIVE_STUNNED},
                CursorClose {"1-1"},

                QueryAscendingRangeToRead {{{"playerId", "all"}, nullptr, nullptr}},
                CursorCheckAllOrdered {
                    "all",
                    {&HUGO_0_KNIGHT_ALIVE_STUNNED, &HUGO_0_KNIGHT_ALIVE_STUNNED, &KARL_1_MAGE_ALIVE_IMMOBILIZED,
                     &XAVIER_2_ARCHER_ALIVE_POISONED, &XAVIER_2_ARCHER_ALIVE_POISONED}},
            }};
}
...
Scenario Deletion ()
{
    return {
        ...
        },
        {
            ...
            QueryAscendingRangeToRead {{{"playerId", "all"}, nullptr, nullptr}},
            CursorCheckAllOrdered {"all", {&HUGO_0_KNIGHT_ALIVE_STUNNED, &XAVIER_2_ARCHER_ALIVE_POISONED}},
        }};
}
...
Scenario EditionAndDeletionFromDescendingCursor ()
{
    return {
        ...
        },
        {
            ...
            CursorCheck {"null-1", &KARL_1_MAGE_ALIVE_IMMOBILIZED},
            CursorEdit {"null-1", &XAVIER_2_ARCHER_ALIVE_POISONED},
            CursorIncrement {"null-1"},
            CursorCheck {"null-1", &HUGO_0_KNIGHT_ALIVE_STUNNED},
            CursorEdit {"null-1", &KARL_1_MAGE_ALIVE_IMMOBILIZED},
            CursorClose {"null-1"},

            QueryAscendingRangeToRead {{{"playerId", "all"}, nullptr, nullptr}},
            CursorCheckAllOrdered {
                "all",
                {&KARL_1_MAGE_ALIVE_IMMOBILIZED, &XAVIER_2_ARCHER_ALIVE_POISONED, &XAVIER_2_ARCHER_ALIVE_POISONED}},
            CursorClose {"all"},

            QueryDescendingRangeToEdit {{{"playerId", "2-2"}, &Queries::ID_2, &Queries::ID_2}},
            CursorCheck {"2-2", &XAVIER_2_ARCHER_ALIVE_POISONED},
            CursorDeleteObject {"2-2"},
            CursorCheck {"2-2", &XAVIER_2_ARCHER_ALIVE_POISONED},
            CursorClose {"2-2"},

            QueryAscendingRangeToRead {{{"playerId", "all"}, nullptr, nullptr}},
            CursorCheckAllOrdered {"all", {&KARL_1_MAGE_ALIVE_IMMOBILIZED, &XAVIER_2_ARCHER_ALIVE_POISONED}},
            CursorClose {"all"},
        }};
}
...
{
    return {{
                RequestPlayerStorage ({&XAVIER_2_ARCHER_ALIVE_POISONED, &HUGO_0_KNIGHT_ALIVE_STUNNED,
                                       &KARL_1_MAGE_ALIVE_IMMOBILIZED, &KARL_1_MAGE_ALIVE_IMMOBILIZED},
            ...
            },
            {
                ...
                CursorCheckAllOrdered {
                    "allIds",
                    {&HUGO_0_KNIGHT_ALIVE_STUNNED, &XAVIER_2_ARCHER_ALIVE_POISONED, &XAVIER_2_ARCHER_ALIVE_POISONED}},
...
{
    return {{
                RequestOrderingStorage (AllFieldTypesStructure::Reflect ().uniqueString),
            },
            {QueryAscendingRangeToRead {{{"ordering", "all"}, nullptr, nullptr}},
             CursorCheckAllOrdered {"all", {&ALL_FIELD_TYPES_1, &ALL_FIELD_TYPES_2, &ALL_FIELD_TYPES_0}}}};
}
