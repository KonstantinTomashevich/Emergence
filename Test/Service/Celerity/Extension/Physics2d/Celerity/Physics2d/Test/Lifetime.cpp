#include <Celerity/Physics2d/Test/Lifetime.hpp>
        ...
        {{0u,
          {
              ...
              AddTransform {{0u}},
              AddRigidBody {{0u}},
              AddCollisionShape {{0u, 0u, "Test"_us, {.type = CollisionGeometry2dType::CIRCLE, .circleRadius = 0.5f}}},
          }},
         {1u,
...
TEST_CASE (CorrectlyChangeShapeGeometry)
{
    Test::ExecuteScenario (
        {{0u,
         ...
         {1u,
          {UpdateCollisionShape {
              {0u, 0u, "Test"_us, {.type = CollisionGeometry2dType::CIRCLE, .circleRadius = 1.25f}}}}}},
        {{0u,
          {
              CheckCollisionShapeExistence {0u, true},
          }},
