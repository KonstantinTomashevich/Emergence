#include <Celerity/Physics3d/Test/Lifetime.hpp>
        ...
        {{0u,
          {
              ...
              AddTransform {{0u}},
              AddRigidBody {{0u}},
              AddCollisionShape {{0u, 0u, "Test"_us, {.type = CollisionGeometry3dType::SPHERE, .sphereRadius = 0.5f}}},
          }},
         {1u,
          {UpdateCollisionShape {
              {0u,
               0u,
               "Test"_us,
               {.type = CollisionGeometry3dType::CAPSULE, .capsuleRadius = 0.5f, .capsuleHalfHeight = 0.5f}}}}}},
        {{0u,
          {
              CheckCollisionShapeExistence {0u, true},
          }},
...
TEST_CASE (CorrectlyChangeShapeGeometry)
{
    Test::ExecuteScenario (
        {{0u,
         ...
         {1u,
          {UpdateCollisionShape {
              {0u, 0u, "Test"_us, {.type = CollisionGeometry3dType::SPHERE, .sphereRadius = 1.25f}}}}}},
        {{0u,
          {
              CheckCollisionShapeExistence {0u, true},
          }},
