...
Container::Vector<Task> PreConditions ()
{
    return {
        ...
        CursorCheckAllOrdered {
            "names", {&HUGO_0_MIN_10_8_4_MAX_11_9_5, &KARL_1_MIN_M2_1_0_MAX_0_4_2, &XAVIER_2_MIN_15_8_50_MAX_19_11_60}},
        CursorClose {"names"},
        ...
        QueryShapeIntersectionToRead {{{"2d", "min = (12, 0), max = (20, 11)"}, {12.0f, 0.0f}, {20.0f, 11.0f}}},
...
{
    Scenario scenario {{RequestStorage ()}, PreConditions ()};
...
Scenario EditAndDeleteUsingVolumetricQuery ()
{
    ...
    scenario.tasks += {
        QueryRayIntersectionToEdit {{{"2d", "origin = (-3, 0), direction = (2, 1)"}, {-3.0f, 0.0f}, {2.0f, 1.0f}}},
