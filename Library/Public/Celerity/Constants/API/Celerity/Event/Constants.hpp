...
#include <Celerity/Event/Implementation/Constants.hpp>
...
constexpr std::size_t MAX_COPY_OUT_BLOCKS_PER_EVENT = Implementation::MAX_COPY_OUT_BLOCKS_PER_EVENT;
...
constexpr std::size_t MAX_TRACKED_ZONES_PER_EVENT = Implementation::MAX_TRACKED_ZONES_PER_EVENT;
...
constexpr std::size_t MAX_ON_CHANGE_EVENTS_PER_TYPE = Implementation::MAX_ON_CHANGE_EVENTS_PER_TYPE;

/// \brief Maximum amount of tracking zones (sets of adjacent fields) per change tracker.
/// \details For performance reasons, tracking zones are stored in inplace vectors,
///          therefore maximum amount of these zones per event is fixed.
constexpr std::size_t CHANGE_TRACKER_MAX_TRACKED_ZONES = Implementation::CHANGE_TRACKER_MAX_TRACKED_ZONES;
...
constexpr std::size_t CHANGE_TRACKER_MAX_TRACKING_BUFFER_SIZE = Implementation::CHANGE_TRACKER_MAX_TRACKING_BUFFER_SIZE;
} // namespace Emergence::Celerity
