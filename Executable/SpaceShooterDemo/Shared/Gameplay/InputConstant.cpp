...
const Emergence::Memory::UniqueString InputConstant::MOVEMENT_ACTION_GROUP {"MovementActionGroup"};
const Emergence::Memory::UniqueString InputConstant::FIGHT_ACTION_GROUP {"FightActionGroup"};
